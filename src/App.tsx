...
function App() {
  ...
  const text = isFrench ? {
    ...
    heroCopy: 'Je suis Hamadoun Oumarou Sidibe, d\u00e9veloppeur Full-Stack en formation. Je transforme des besoins concrets en applications web et mobiles claires, utiles et pr\u00eates \u00e0 \u00e9voluer.',
    ...
    heroCopy: 'I\u2019m Hamadoun Oumarou Sidibe, a full-stack developer in training. I turn practical needs into clear, useful web and mobile products built to evolve.',
